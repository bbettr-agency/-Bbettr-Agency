...
/**
 * Premium "what you get" showcase. Source of truth is the client's actual
 * purchased services; each expands into client-friendly deliverables. Services
 * the client hasn't bought appear separately as Growth Opportunities — never as
 * active deliverables. Presentation only.
 */
